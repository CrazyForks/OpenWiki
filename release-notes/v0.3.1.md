...
- Fixed Intel Mac build of v0.3.0 failing to publish — Intel Mac users can now download and use OpenWiki again

## Installation (macOS)

1. Download the `.dmg` file that matches your Mac:
   - **Apple Silicon (M1/M2/M3/M4)**: `OpenWiki_0.3.1_aarch64.dmg`
   - **Intel Mac**: `OpenWiki_0.3.1_x64.dmg`
...
1. 下载与你的 Mac 对应的 `.dmg` 文件：
   - **Apple Silicon（M1/M2/M3/M4）**：`OpenWiki_0.3.1_aarch64.dmg`
   - **Intel 芯片 Mac**：`OpenWiki_0.3.1_x64.dmg`
